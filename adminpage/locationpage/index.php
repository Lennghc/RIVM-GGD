...
if ($preparedquery->errno) {
	$_SESSION['message'] = alertMsg('Fout bij uitvoeren commando', null, "danger");
} else {
	$result = $preparedquery->get_result();

	if($result->num_rows === 0) {
        $_SESSION['message'] = alertMsg('Geen locaties gevonden', null, "danger");
	} else {
		...
		while($row = $result->fetch_assoc()) {
            ...
            $textForHtml .= "<strong>Straat: </strong>" . $row['adres'] . ' ' . $row['houseNumber'] . "<br>";
            $textForHtml .= "<strong>Locatie: </strong>" . $row['zipcode'] . ', '. $row['city'] . "<br>";
            $textForHtml .= "</p>";
    ...
    <body>
        ...
        <section class="mb-5 p-5 mt-3" style="background-color: #fdf6bb;">
            <div class="container">
                ...
                <h5 class='text-center'>Huidige locaties</h5>
                ...
                <div class="col-sm-12 mb-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Voeg hier een nieuwe locatie toe.</p>
                            <button type="button" class="btn btn-rivm" data-toggle="modal" data-target="#coronaModal"><a class="btn btn-rivm" href="addform.php">Nieuwe locatie toevoegen</a></button>
                        </div>
                    </div>
                </div>
            </div>
