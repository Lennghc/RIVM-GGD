...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <ul class="navbar-nav mx-auto">
        ...
        <li class="nav-item">
            ...
            <a class="nav-link" href="/adminpage/userpage/">Gebruikers</a>

        </li>

        <li class="nav-item">

            <a class="nav-link" href="/adminpage/reservepage/">Reserveringen</a>
        ...
        <li class="nav-item">
            ...
            <a class="nav-link" href="/adminpage/locationpage/">Locaties</a>

        </li>

        <li class="nav-item">

            <a class="nav-link" href="/adminpage/vaccinpage/">Vaccinaties</a>
